...
def stage_proven_reserves(project_root_path: str) -> pd.DataFrame:
    proven_reserves_gas = _get_proven_reserves(project_root_path=project_root_path, fossil_fuel="gas")
    proven_reserves_oil = _get_proven_reserves(project_root_path=project_root_path, fossil_fuel="oil")
...
def _get_proven_reserves(project_root_path: str, fossil_fuel: str) -> pd.DataFrame:
    ...
    proven_reserves_filepath = os.path.join(
        project_root_path,
        f"data/opec/stg_proven_reserves_{fossil_fuel}.csv"
    )
