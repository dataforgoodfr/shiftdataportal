...
mapping_country_names = {
    ...
    "Chile": "Chile",
    "Chili": "Chile",
    "Rép. populaire de Chine": "China",
    "Chine": "China",
    "China": "China",
    "People's Republic of China": "China",
    # TODO: Doit être mappée avec 'China' et non 'China, mainland'?
    ...
    "Middle East": "Delete",
    "Delete": "Delete",
    "Central & South America": "Delete",
    "Antarctica": "Antarctica",
    "Eurasia": "Delete",
    "Hawaiian Trade Zone": "Hawaiian Trade Zone",
    "Asia & Oceania": "Delete",
    "North America": "Delete",
    "Africa": "Delete",
    ...
    "Congo-Kinshasa": "Democratic Republic of the Congo",
    # TODO - fusionner les pays Congo avec Democratic Republic of the Congo ?
    ...
    "Estonie": "Estonia",
    "Estonia": "Estonia",
    # TODO - fixer la traduction de European Union (28) dans des fichiers comme cait.py ?
    "European Union (28)": "EU28",
    "Eswatini": "Eswatini",
    # TODO - vérifier quel nom utiliser entre Swaziland et Eswatini
    "Swaziland": "Eswatini",
    ...
    "Polynesie Franc.": "French Polynesia",
    ...
    "Inde ": "India",
    "India": "India",
    "Indonesia (including Timor until 1999)": "Indonesia",
    "Indonésie": "Indonesia",
    "Indonesia": "Indonesia",
    "Indonesie": "Indonesia",
    ...
    "Iraq": "Iraq",
    "Iraq*": "Iraq",
    "Int. Aviation": "International Aviation",
    "Int. Shipping": "International Shipping",
    ...
    "Pays-Bas": "Netherlands",
    "Netherlands (Offshore)": "Netherlands",
    ...
    "Null": "Null SRES",
    "Null SRES": "Null SRES",
    "OECD90 SRES": "OECD90 SRES",
    "OECD90": "OECD90 SRES",
    "Other Africa": "Other Africa BP",
    "Other Africa BP": "Other Africa BP",
    "Other Asia Pacific": "Other Asia Pacific BP",
    ...
    "Other Middle East BP": "Other Middle East BP",
    "Other Middle East": "Other Middle East BP",
    "Other S & Cent America BP": "Other S & Cent America BP",
    "Other S. & Cent. America": "Other S & Cent America BP",
    "Oman": "Oman",
    "Pakistan": "Pakistan",
    "Palau": "Palau",
    "State of Palestine": "Palestine",
    "Palestine": "Palestine",
    "Panama Zone Canal": "Panama",
    "Panama": "Panama",
    "Papouasie Nlle G.": "Papua New Guinea",
    ...
    "Russian Federation & U.S.S.R.": "Russian Federation & USSR",
    "Reunion": "Reunion",
    "Réunion": "Reunion",
    "Rwanda": "Rwanda",
    ...
    "Rep. Corée": "South Korea",
    "Corée": "South Korea",
    "Korea, South": "South Korea",
    "Republic of Korea": "South Korea",
    "Rep. De Coree": "South Korea",
    "Korea, Rep.": "South Korea",
    "Korea": "South Korea",
    "Rep. Coree": "South Korea",
    ...
    "Viêt-Nam": "Viet Nam",
    "North Vietnam (D.R.V.)": "Viet Nam",
    "South Vietnam (R.V.)": "Viet Nam",
    "Viet Nam": "Viet Nam",
    "Vietnam": "Viet Nam",
    "Wake Island": "Wake Island",
    "Western Sahara": "Western Sahara",
    # TODO: fixer la traduction de World dans des fichiers comme cait.py ?
    "World": "World",
    "Yemen": "Yemen",
    "Yémen": "Yemen",
...
class CountryNameTranslator:
    ...
    def run(
        ...
        :param series_country_to_translate: (pandas Series) to translate.
