...
def process_final_greenhouse_gas_emissions_by_sector(
    ...
    ghg_emissions_by_country = prepare_stg_dataset_for_prod(
        ghg_emissions_by_country, is_gas_dataset=False
    )
