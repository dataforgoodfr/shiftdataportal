...
# Yearly proven reserves of oil
df = opec.stage_yearly_proven_reserves_oil(OPEC_DATA_PATH)
dst_filepath = os.path.join(OPEC_DATA_PATH, "stg_yearly_proven_reserves_oil.csv")
df.to_csv(dst_filepath, index=False)
