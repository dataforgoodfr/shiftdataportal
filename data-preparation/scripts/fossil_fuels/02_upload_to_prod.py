...
filepath = os.path.join(FOSSIL_FUELS_DATA_PATH, "stg_yearly_proven_reserves.csv")
df = pd.read_csv(filepath)
dst_filepath = os.path.join(PROD_DATA_PATH, "FOSSIL_RESERVES_bp_fossil_with_zones_prod.csv")
