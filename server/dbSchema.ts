...
export const KAYA_kaya_base_100_prod = {
  ...
  co2_per_energy: "co2_per_energy",
  population_lag_diff: "population_lag_diff",
  population_variation: "population_variation",
  gdp_lag_diff: "gdp_lag_diff",
  energy_lag_diff: "energy_lag_diff",
  co2_lag_diff: "co2_lag_diff",
  co2_variation: "co2_variation",
  gdp_per_capita_lag_diff: "gdp_per_capita_lag_diff",
  gdp_per_capita_variation: "gdp_per_capita_variation",
  energy_per_gdp_lag_diff: "energy_per_gdp_lag_diff",
  energy_per_gdp_variation: "energy_per_gdp_variation",
  co2_per_energy_lag_diff: "co2_per_energy_lag_diff",
  co2_per_energy_variation: "co2_per_energy_variation",
  population_b100: "population_b100",
  gdp_per_capita_b100: "gdp_per_capita_b100",
...
export const KAYA_kaya_variations_prod = {
  ...
  energy_intensity_of_economy_variation:
    "energy_intensity_of_economy_variation",
...
export const OIL_EXTRAPOLATION_oil_prod_weo_extrapolated_prod = {
  ...
  oil_production_unit: "oil_production_unit",
  cumulated_oil_prod_since_2018: "cumulated_oil_prod_since_2018",
  extrapolation_curve: "extrapolation_curve",
...
export const WORLD_ENERGY_HISTORY_renewable_share_of_primary_energy_prod = {
  ...
  year: "year",
  type: "type",
  renewable_primary_energy: "renewable_primary_energy",
